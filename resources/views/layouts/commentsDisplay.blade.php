    ...
    <div class="px-8 py-2 bg-gray-100 divide-y rounded my-4 shadow-md" @if($comment->parent_id != null) style="margin-left:40px;" @endif>
        <div x-data="{ open: false }">
            <div class="flex items-center">
                ...
                <button @click="open = true" class="flex items-center gap-2 rounded-full bg-white px-2 py-0 my-2 mx-4 text-red-600 text-xs font-semibold border border-red-400 focus:outline-none">
                    <svg class="w-2 h-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6"></path></svg>
                    Reply
                </button>
